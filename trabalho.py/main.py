...
icone  = pygame.image.load(os.path.join(BASE_DIR, "assets", "icone.png"))
...
fundo = pygame.image.load(os.path.join(BASE_DIR, "assets", "background.jpg"))
fundoDead = pygame.image.load(os.path.join(BASE_DIR, "assets", "backgroundDead.jpg"))
fundoStart = pygame.image.load(os.path.join(BASE_DIR, "assets", "backgroundStart.jpg"))

iron = pygame.image.load(os.path.join(BASE_DIR, "assets", "IronMan.png"))
iron = pygame.transform.scale(iron, (116,51))
missel = pygame.image.load(os.path.join(BASE_DIR, "assets", "missile.png"))
missel = pygame.transform.scale(missel, (125,25))
missileSound = pygame.mixer.Sound(os.path.join(BASE_DIR, "assets", "missile.wav"))
explosaoSound = pygame.mixer.Sound(os.path.join(BASE_DIR, "assets", "explosao.wav"))
pygame.mixer.music.load(os.path.join(BASE_DIR, "assets", "ironsound.mp3"))
